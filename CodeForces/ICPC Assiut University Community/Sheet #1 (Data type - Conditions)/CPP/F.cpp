...
int main() {
    ...
    // Declare two variables N and M of type 'long long' to store the input numbers.
    // 'long long' is used because the numbers can be as large as 10^18, which cannot fit in regular int.
    long long N, M;
